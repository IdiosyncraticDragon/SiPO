...
other_GPU_IDs = [GPU_ID, GPU_ID, GPU_ID, GPU_ID, GPU_ID] # devices used for individuals, one device id for one individual
...
sys.path.insert(0, cfg.PROJECT_PACKAGE)
...
logger_path = '{}/{}{}_{}'.format(cfg.PROJECT_LOG, name_mark, acc_percent_prune, cfg.LM_LOG_MARK)
...
def main():
    ...
    while run_times < total_times:
        ...
        torch.save(masked_model.masked_model, cfg.LM_MODEL_TMP_FOLDER+saved_model_name)
        ...
        try:
            for epoch in range(1, RETRAIN_EPOCHS + 1):
                ...
                if not best_val_loss or val_loss < best_val_loss:
                    with open("{}/{}{}_iterative_retrain_model_runtime{}_epoch_{}.pt".format(cfg.LM_MODEL_PATH, name_mark, acc_percent_prune,  run_times, epoch), 'wb') as f:
