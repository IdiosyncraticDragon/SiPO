...
logger_path = '{}/test/rnnsearch4-2-logs'.format(HOME_PATH)
...
def main():
    ...
    while run_times < total_times:
        ...
        _, saved_model = update_checkpoint(checkpoint, masked_model, run_times, acc_percent_prune)
        ...
        masked_model = MaskedModel(model_for_train.masked_model, group_dict, cuda.current_device(), cuda.current_device())
