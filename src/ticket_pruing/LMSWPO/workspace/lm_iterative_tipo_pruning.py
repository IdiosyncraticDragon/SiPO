...
HOME_PATH='/home/liguiying'
DATA_PATH='/data/liguiying'
MODEL_PATH='/data/liguiying'
#reload(sys)
#sys.setdefaultencoding('utf-8')
sys.path.insert(0, '{}/gitProject/dgx2-OpenNMT-py'.format(HOME_PATH))
sys.path.insert(0, '{}/gitProject/dgx2-OpenNMT-py/workspace/package'.format(HOME_PATH))
