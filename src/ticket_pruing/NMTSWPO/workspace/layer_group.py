...
'encoder_embedding':['encoder.embeddings.make_embedding.emb_luts.0.weight'],\
'decoder_embedding':['decoder.embeddings.make_embedding.emb_luts.0.weight'],\
'encoder_ih0':['encoder.rnn.weight_ih_l0','encoder.rnn.bias_ih_l0'],\
'encoder_ih1':['encoder.rnn.weight_ih_l1','encoder.rnn.bias_ih_l1'],\
'encoder_ih2':['encoder.rnn.weight_ih_l2','encoder.rnn.bias_ih_l2'],\
'encoder_ih3':['encoder.rnn.weight_ih_l3','encoder.rnn.bias_ih_l3'],\
'decoder_ih0':['decoder.rnn.layers.0.weight_ih','decoder.rnn.layers.0.bias_ih'],\
'decoder_ih1':['decoder.rnn.layers.1.weight_ih','decoder.rnn.layers.1.bias_ih'],\
'decoder_ih2':['decoder.rnn.layers.2.weight_ih','decoder.rnn.layers.2.bias_ih'],\
'decoder_ih3':['decoder.rnn.layers.3.weight_ih','decoder.rnn.layers.3.bias_ih'],\
'encoder_hh0':['encoder.rnn.weight_hh_l0','encoder.rnn.bias_hh_l0'],\
'encoder_hh1':['encoder.rnn.weight_hh_l1','encoder.rnn.bias_hh_l1'],\
'encoder_hh2':['encoder.rnn.weight_hh_l2','encoder.rnn.bias_hh_l2'],\
'encoder_hh3':['encoder.rnn.weight_hh_l3','encoder.rnn.bias_hh_l3'],\
'decoder_hh0':['decoder.rnn.layers.0.weight_hh', 'decoder.rnn.layers.0.bias_hh'],\
'decoder_hh1':['decoder.rnn.layers.1.weight_hh', 'decoder.rnn.layers.1.bias_hh'],\
'decoder_hh2':['decoder.rnn.layers.2.weight_hh', 'decoder.rnn.layers.2.bias_hh'],\
'decoder_hh3':['decoder.rnn.layers.3.weight_hh', 'decoder.rnn.layers.3.bias_hh'],\
'attn':['decoder.attn.linear_in.weight', 'decoder.attn.linear_out.weight'],\
'pred':['generator.0.weight', 'generator.0.bias']
}
'''
'''
# embedding combined with prediction + time-wise
group_dict={
...
'''
'''
# embedding combined with prediction + layer-wise + time-wise
group_dict={
'embedding':['encoder.embeddings.make_embedding.emb_luts.0.weight','decoder.embeddings.make_embedding.emb_luts.0.weight','generator.0.weight', 'generator.0.bias'],\
...
'''
# time-wise
group_dict={ 'encoder_embedding':['encoder.embeddings.make_embedding.emb_luts.0.weight'],\ 'decoder_embedding':['decoder.embeddings.make_embedding.emb_luts.0.weight'],\
